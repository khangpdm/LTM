...
public class Client extends Application {
    ...
    public void start(Stage stage) {
        ...
        // Load CSS an toan: neu khong tim thay thi khong crash app
        java.net.URL cssUrl = getClass().getResource("/utils/Configure.css");
        if (cssUrl != null) {
            scene.getStylesheets().add(cssUrl.toExternalForm());
        } else {
            System.out.println("CSS file not found: /utils/Configure.css");
        }
